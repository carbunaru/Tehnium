                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-2" scope="col">@sortablelink('title', 'Title') / Slug / @sortablelink('created_at', 'Created')</th>
                                        ...
                                        @foreach($pages as $page)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="text-info">{{ $page->slug }}</span><br>
                                                ...
                                                <td> 
                                                    <a href="{{ route('admin.showCategoriesArticles',$page->id) }}" class="btn btn-success btn-circle btn-md mb-1" title="Add category"><i class="fas fa-2x fa-list-ul m-1"></i></a>
                                                    <a href="{{ route('admin.showFormPhotos',$page->id) }}" class="btn btn-success btn-circle btn-md mb-1" title="Add gallery"><i class="fas fa-2x fa-camera m-1"></i></a>
                                                    <a href="{{ route('admin.editArticles',$page->id) }}" class="btn btn-success btn-circle btn-md  mb-1" title="Edit article"><i class="fas fa-2x fa-pencil-alt m-1"></i></a>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-circle btn-md  mb-1 confirm" title="Delete article"
